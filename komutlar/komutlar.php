...
<title>Yn3ox Komutlar Menüsü</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no" />
<link rel="shortcut icon" href="https://www.ofgamers.org/wp-content/uploads/2020/09/original-wumpus.png" />
...
Yn3ox Botumuzun Komutları Aşağıda Listelenmiştir.
</div>
<div class="links">
<a href="https://discord.com/oauth2/authorize?client_id=840868528100868096&scope=bot&permissions=8" target="_blank" class="btn btn-fill-primary btn-large"><i class="fad fa-plus"></i>・Sunucuna Ekle</a
          ><a href="https://discord.gg/ghabnNdEZn" class="btn btn-fill-secondary btn-large" target="_blank"><i class="fab fa-discord"></i>・Discord</a
          >
</div>
</div>
<div class="hero">
...
<div class="title" style="text-align:center; font-size: 40px; " >
        Yn3ox Bots Komutları<hr>
</div>
<div class="description" >
    <li style="list-style-type: none;">
        <p><i class="fas fa-code"></i><a href=""> Yardım </a> ・ Bottaki Bütün Komutları Gösterir. </p>
        <p><i class="fas fa-code"></i><a href=""> Ban </a> ・ Sunucuda Bulunan Kullanıcıyı Yasaklar. </p>
        <p><i class="fas fa-code"></i><a href=""> UnBan </a> ・ Yasakladığınız Kullanıcının Yasağını Kaldırır. </p>
        <p><i class="fas fa-code"></i><a href=""> Kick </a> ・ Sunucuda Bulunan Kullanıcıyı Atar. </p>
        <p><i class="fas fa-code"></i><a href=""> Otorol </a> ・ Sunucuya Katılan Üyelere Otomatik Rol Verir. </p>
        <p><i class="fas fa-code"></i><a href=""> Hosgeldin </a> ・ Hoşgeldin Kanalını Belirlersiniz. </p>
        <p><i class="fas fa-code"></i><a href=""> Sil </a> ・ 1'den 100'e Kadar Mesaj Siler. </p>
        <p><i class="fas fa-code"></i><a href=""> Ping </a> ・ Botun Gecikme Süresine Bakarsınız. </p>
        <p><i class="fas fa-code"></i><a href=""> Davet </a> ・ Botu Sunucunuza Davet Edersiniz. </p>
        <p><i class="fas fa-code"></i><a href=""> Avatar </a> ・ İstediğiniz Kişinin Profil Resmini Gösterir. </p>
        <p><i class="fas fa-code"></i><a href=""> İstatistik </a> ・ Botun İstatistiklerini Gösterir. </p>
    </li>
</div>  
</div>
<div class="title">
...
<a href="https://discord.com/oauth2/authorize?client_id=840868528100868096&scope=bot&permissions=8" class="btn btn-fill-primary btn-large btn-invite jellyButton" target="_blank"><i class="fa fa-star"></i> Botu Ekle</a>
</div>
</div>
</div>
<svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 1440 320" class="waves bottom-waves" preserveaspectratio="none">
<path fill="#292933" class="waves-up-path" fill-opacity="1" d="M0,32L30,53.3C60,75,120,117,180,117.3C240,117,300,75,360,48C420,21,480,11,540,37.3C600,64,660,128,720,149.3C780,171,840,149,900,122.7C960,96,1020,64,1080,74.7C1140,85,1200,139,1260,170.7C1320,203,1380,213,1410,218.7L1440,224L1440,320L1410,320C1380,320,1320,320,1260,320C1200,320,1140,320,1080,320C1020,320,960,320,900,320C840,320,780,320,720,320C660,320,600,320,540,320C480,320,420,320,360,320C300,320,240,320,180,320C120,320,60,320,30,320L0,320Z"></path>
</svg>
<footer>
<img src="https://www.ofgamers.org/wp-content/uploads/2020/09/original-wumpus.png" width="50px" height="50px"><br>
    <div class="copyright">
        Copyright &copy; Yn3ox - YouTube <b class="currentYear">owo</b>
    </div>
